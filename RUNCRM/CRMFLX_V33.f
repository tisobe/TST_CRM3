...
C     Open input file containing magnetosphere data.
      IF(ISPECI.EQ.1) THEN
        OPEN(LUNIT,FILE='/data/mta4/proj/rac/ops/CRM3/RUNCRM/MSPH_Kp_PRO&
     &T.BIN',
C    &T.ASC',
...
C     Open input file containing magnetosheath data.
      IF(ISPECI.EQ.1) THEN
        OPEN(LUNIT,FILE='/data/mta4/proj/rac/ops/CRM3/RUNCRM/MSheath_Kp_&
     &PROT.BIN',
C    &PROT.ASC',
     $    ACCESS='SEQUENTIAL',FORM='UNFORMATTED',STATUS='OLD')
      ELSE IF(ISPECI.EQ.2) THEN
...
C     Open input file containing solar wind data.
      IF(ISPECI.EQ.1) THEN
        OPEN(LUNIT,FILE='/data/mta4/proj/rac/ops/CRM3/RUNCRM/SolWind_Kp_&
     &PROT.BIN',
C    &PROT.ASC',
     $    ACCESS='SEQUENTIAL',FORM='UNFORMATTED',STATUS='OLD')
      ELSE IF(ISPECI.EQ.2) THEN
