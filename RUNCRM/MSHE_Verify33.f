      PROGRAM MSHE_Verify_V33
C
C     Simple test driver for verifying the magnetosheath database has been correctly converted from
C     ASCII to binary format.  Calculates flux at a single point.
C
      INTEGER LUNIT(3),SMOOTH1,FPCHI,FPCLO
C
      OPEN(40,FILE='MSHE_Verify.OUT',ACCESS='SEQUENTIAL',
...
C
      ...
      WRITE(*,*)' Input Summary'
      WRITE(*,*)
      WRITE(*,*)' Magnetosheath Database Verification'
      WRITE(*,*)
      WRITE(*,100) XKP
      WRITE(*,101) XGSM
      WRITE(*,102) YGSM
...
C
      ...
      WRITE(40,*)
      WRITE(40,*)' Magnetosheath Database Verification'
      WRITE(40,*)
      WRITE(40,100) XKP
      WRITE(40,101) XGSM
      WRITE(40,102) YGSM
...
C
      WRITE(*,*)
      WRITE(*,*)' Output summary in file ''MSHE_Verify33.OUT'''
      PAUSE  'PAUSED'
C
1     FORMAT(A)
C
